...
LANG = {
    "vi": {
        ...
        "help_full": (
            ...
            "• /autoban_on | /autoban_off – Bật/tắt tự động cấm thành viên vi phạm 3 lần\n"
            "• /log_view – Xem nhật ký vi phạm của các thành viên trong nhóm\n"
    ...
    "en": {
        ...
        "help_full": (
            ...
            "• /autoban_on | /autoban_off – Enable/disable automatic ban after 3 violations\n"
            "• /log_view – View the violation logs of members in the group\n"
            "📢 <b>AUTO PROMOTION</b>\n"
