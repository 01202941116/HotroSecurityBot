...
from .models import init_db, SessionLocal, Filter, Setting
from .license_manager import generate_key, redeem_key, start_trial, check_and_downgrade_expired
...
def register_handlers(app):
    # Store in bot_data for decorators
